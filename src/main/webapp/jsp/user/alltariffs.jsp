...
<div>
<p align="center"> <a href="http://localhost:8080/MainServlet/alltar"><b> All tariffs list </b></a> </p>
<form name="newuserform" method="post" action="http://localhost:8080/MainServlet/changeUserTar">
 <table>
        <thead>
            <tr>
                <th>Tariff Id</th>
